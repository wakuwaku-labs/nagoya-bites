...
### [ISSUE-059] features/*.html の JSON-LD 全体が「名古屋ラーメン」になっている重大スキーマ汚染 🟡
- **priority**: P1（schema 汚染・Google の信頼毀損・20 ファイルに波及）→ **status**: partial（自動修復済 / per-file FAQPage 再追加: 1/20 完了 — `nagoya-yakitori.html` 2026-05-25）
- **resolved（schema 汚染部分）**: 2026-05-25
- **detected**: 2026-05-25
